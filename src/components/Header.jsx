...
const Header = () => {
    ...
    return (
        <div className={`flex flex-col md:items-center justify-center gap-2 md:gap-5 px-10 md:px-20 py-5 z-1 ${scrollY ? "static opacity-0" : "sticky opacity-100"}
    ${window.scrollY !== 0 && !scrollY ? "bg-gray-50" : null}
